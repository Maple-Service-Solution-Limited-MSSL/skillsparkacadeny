...
<html lang="en">
  <head>
    ...
    <style>
      ...
      .hero {
          position: relative;
          z-index: 1; /* Ensure the hero content is above the animated circles */
      }
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 fw-semibold ">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link customhover dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                  Course
                </a>
