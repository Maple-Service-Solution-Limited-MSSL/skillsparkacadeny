...
<div class="area">
        ...
        <div class="hero">
            <div class="container col-xxl-8 py-5 hero-div ">
                <div class="row flex-lg-row-reverse align-items-center py-5 ">
                    <div class="col-10 col-6  col-sm-8 col-lg-6 v6 ">
                        ...
                        <img src="./assets/images/hero-img.png" class="img-fluid d-none d-md-block hero-img mx-lg-auto pt-5" alt="Hero Image" loading="lazy" fetchpriority="high">
                        <img src="./assets/images/hero-img.png" class="img-fluid d-block d-md-none hero-img mx-md-auto" alt="Hero Image" loading="lazy" fetchpriority="high">  
                    </div>
                    <div class="col-lg-6 ">
...
<?php require("./templates/sticky-card.php") ?>
